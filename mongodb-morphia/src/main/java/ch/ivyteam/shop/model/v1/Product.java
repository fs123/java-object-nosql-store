...
public class Product extends AddToStringHashCodeAndEquals
{
  public static Product create(String name, int price, Vendor vendor, String offerText)
  {
    Product product = new Product();
    product.name = name;
    product.price = price;
    product.vendor = vendor;
    product.options = new ProductOptions();
    product.options.specialOfferText = offerText;
    return product;
  }
  ...
  @Embedded
  public ProductOptions weekendOptions;
